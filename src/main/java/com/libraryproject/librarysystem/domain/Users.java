...
public class Users {
    ...
    public Users(String userName, String userFullName, String phone, String email) {
    ...
    public Users(int userID, String userName, String password, String userFullName, String phone, String email, AccessLevel accessLevel) {
        this.userID = userID;
        this.userName = userName;
        this.password = password;
        this.userFullName = userFullName;
    ...
    public void setMyOrders(List<Orders> ordersList) {
    }
}
